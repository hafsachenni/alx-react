...
describe('listNotifications without values', () => {
  ...
  describe('markAsRead', () => {
  test('test that will mockup the console.log function', () => {
    const wrapper = shallow(<Notifications displayDrawer />);
    console.log = jest.fn();
  ...
  test('verifying that when updating the props of the component with the same list, the component does not rerender', () => {
  ...
  test('verifying that when updating the props of the component with a longer list, the component does rerender', () => {
    const listNotifications = [
      { id: 1, type: 'default', value: 'New course available' },
      { id: 2, type: 'urgent', value: 'New resume available' },
    ];
